...
@section('content')
		...
		{{-- <div class="home">.                   Slide Show bị lỗi hiển thị
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(sublime/images/home_slider_1.jpg)"></div>
			...
			<div class="avds_large">
				...
				<div class="avds_large_container">
					<div class="avds_large_content">
						<div class="avds_title">Máy ảnh chuyên nghiệp</div>
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="product.html">Loa vi tính</a></div>
								<div class="product_price">$670</div>
							</div>
						</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="product.html">Cáp sạc</a></div>
								<div class="product_price">$670</div>
							</div>
						</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="product.html">Tai nghe</a></div>
								<div class="product_price">$670</div>
							</div>
						</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="product.html">Iphone 7 Plus</a></div>
								<div class="product_price">$670</div>
							</div>
						</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_title"><a href="product.html">Keyboard</a></div>
								<div class="product_price">$670</div>
							</div>
						</div>
